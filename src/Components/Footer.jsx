...
const Footer = () => {
  const socialIcons = [
    ...
    { icon: FaEnvelope, href: "mailto:info@decora10.com", label: "Email" },
  ];
...
<div className="col-md-3 mb-4">
  ...
  {categories.map(({ id, name, slug }) => {
    ...
    return (
      ...
      >
        {name}
          ...
          <div className="col-md-3 mb-4">
            ...
            <p className="text-white-50">Suscríbete para recibir ofertas y novedades</p>
      ...
      {/* Estilos internos para responsividad */}
      <style jsx="true">{`
        .footer-bg-circle {
          position: absolute;
          border-radius: 50%;
